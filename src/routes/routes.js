...
routes.put("/personagens", PersonagemMiddleware.validaId, PersonagemController.update)
routes.delete('/personagens', PersonagemMiddleware.validaId, PersonagemController.del)
